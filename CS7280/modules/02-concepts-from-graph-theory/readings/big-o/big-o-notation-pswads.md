...
> Source: https://runestone.academy/ns/books/published/cppds/AlgorithmAnalysis/BigONotation.html — *Problem Solving with Algorithms and Data Structures using C++* (Miller & Ranum), §2.3.
...
**Table 1: Common Big-O Functions**
...
*The source page includes interactive self-check activities (multiple-choice and Parsons drag-and-drop exercises) that are omitted here; see the [source page](https://runestone.academy/ns/books/published/cppds/AlgorithmAnalysis/BigONotation.html) for the interactive versions.*
